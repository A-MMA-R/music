...
from Music.MusicUtilities import command
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [        
            ...
            InlineKeyboardButton(text=f"•  الــــمطور •", url=f"https://t.me/X_A_R3"),
        ],
        [
...
async def play(_, message: Message):
    if len(message.command) == 1:
        ...
        await app.send_message(
            message.chat.id,
            text=f"""**
[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴍᴜsɪᴄ ](https://telegra.ph/file/a0e09a94b8e7fdc688baf.jpg)
ꔹ━━ꔹ━ꔹ━━ꔹꔹ━━ꔹ━ꔹ━━ꔹ
