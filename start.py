...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton(text=f"•  الدعم •", url=f"https://t.me/{GROUP}"),
            InlineKeyboardButton(text=f"•  السورس •", url=f"https://t.me/{CHANNEL}"),
        ],
        [
            InlineKeyboardButton(text=f"•  الاوامر •", callback_data="cbbasic"),
        ],
    ]
    return (
        "🎛 **{BOT_NAME} هو بوت تشغيل اغاني وفيديوهات في الدردشة الصوتية المجموعة**",
        buttons,
    )
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [        
            InlineKeyboardButton(text=f"•  بوت السورس •", url=f"https://t.me/fi0nabot"),
        ...
        [
            ...
            InlineKeyboardButton(text=f"•  قناه السورس •", url=f"https://t.me/{CHANNEL}"),
        ],
        [        
            InlineKeyboardButton(text=f".َ ‹𝙱𝙰𝙽𝙳𝙰 || بـانـدا .𓁷", url=f"https://t.me/X_A_R3"),
        ],
    ]
)
